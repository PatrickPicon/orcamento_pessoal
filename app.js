class Despesa {
	...
	validarDados() {
		...
		/*Usando o for, a instrução i nos trás o indice do objeto não o valor,
		e o this faz referência para própria despesa
		Utilizando this[i], junto com a referência aos atributos de um objeto e o token []
		É o mesmo que acessar this.ano
		*/
		for(let i in this)
...
class Bd {
	...
	//Faz a busca do indice 'id' dentro do localStorage
	getProximoId() {
...
function cadastrarDespesa() {
	...
	if(despesa.validarDados()) {
		...
		despesa.resetarCampos()

		//dialog de sucesso jQuerry
...
function carregaListaDespesas(despesas = Array(), filtro = false) {
   ...
   */
   ...
   btn.onclick = function() {
   	...
   	//substituindo a string id_despesa_ por um valor vazio para recuperar apenas o ID
   	...
   	//método de atualizar página atual
